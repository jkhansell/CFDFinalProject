...
def GRTairfoilsim(tScheme, Re, Tu, nu, nuratio, aoa,
                mesh_controls, rhoInf,
                Nsteps, airfoilpath, save_path="../runs/"):

    # Physical variables setup
    chord_length  = mesh_controls["chordlength"]
    span = mesh_controls["span"]
    ...
    structuredmesh.structured_mesh(airfoilpath, writepath, mesh_controls)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scheme", 
                        help="Definition of solution scheme. (Steady / unsteady", 
                        type=str) # unsteady solution is not yet supported
    ...
    parser.add_argument("--nuratio", 
                       help="Definition of viscosity ratio for airfoil simulation.", 
                        type=float)
    ...
    parser.add_argument("--rho", 
                        help="Definition of density of fluid for lift and drag coefficients.",
                        type=float)
    ...
    parser.add_argument("--nsteps", 
                        help="Definition of number of steps to take in simulation.", 
                        type=int)
    ...
    parser.add_argument("--meshcontrols",
                        help="Definition of mesh parameters. (.json file located in ./meshparams)",
                        type=str)
    ...
    GRTairfoilsim(args.scheme, args.Reynolds, args.Tu, 
                    ...
                    mesh_params, args.rho, args.nsteps, 

...
def mesh_airfoil(airfoilpath, angleofattack, writepath, 
    ...
    for i in range(len(airfoildata)):
        gmsh.model.occ.addPoint(airfoildata[i,0], airfoildata[i,1], 0.0, tag=i+1)
        tags.append(i+1)
    tags.append(1)
    ...
    p1 = gmsh.model.occ.addPoint(AFcentroid[0]-10*chord_length, AFcentroid[1]-10*chord_length,0.0)
    p2 = gmsh.model.occ.addPoint(AFcentroid[0]+15*chord_length, AFcentroid[1]-10*chord_length,0.0)
    p3 = gmsh.model.occ.addPoint(AFcentroid[0]+15*chord_length, AFcentroid[1]+10*chord_length,0.0)
    p4 = gmsh.model.occ.addPoint(AFcentroid[0]-10*chord_length, AFcentroid[1]+10*chord_length,0.0)
